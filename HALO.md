...
**Status:** Project scoping complete. Name locked: **Halo** (2026-04-25). Grant ask locked: **$20k** Solana Mobile Builder Grant.
...
15. [Budget Plan ($20k)](#15-budget-plan-20k)
...
| **Grant ask** | **$20k** from Solana Mobile Builder Grants (locked 2026-04-25) |
...
|---|---|---|
| Solana program audit | $5,000 | Halborn / OtterSec / Sec3 focused-scope audit of verifier program (covers SAS verification + policy registry + issuer authority) |
| RPC + infra (12 months) | $1,500 | Helius Pro tier for tx simulation queries during demo + early adoption |
| Seeker device | $500 | Buy one for end-to-end testing on real hardware |
| Documentation site + branding + domain | $1,000 | Domain (halo.dev / halo.so), Vercel deploy, brand pass, design assets for demo video |
| Demo video production | $1,000 | Voiceover + light motion graphics for the 3-min grant demo (justifies the line that wins reviewer attention) |
| Compensation for solo dev (Pratik) | $9,500 | 4-week MVP sprint + 2 months post-grant adoption support (Phantom/Backpack/wallet partnership outreach) |
| Junior contributor (docs + branding) | $1,000 | ~10 hrs of paid contractor work to free Pratik to code |
| Conference / dev relations | $500 | Travel + lightweight presence at Breakpoint India / Solana India event |

**Total: $20,000.**

If only $10k granted, scope cuts: drop junior contributor, drop conference, defer audit to post-MVP, total = $10k. If $15k, restore audit + Helius. If $20k (target), full plan as above.
