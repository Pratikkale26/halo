...
| **0:08 – 0:25** | Switch to emulator/phone. Show the Halo Demo home screen. | "Solana users lost over $90 million to wallet drainers in the first half of 2025. April first this year, Drift Protocol was exploited for $285 million. The drainer kits are evolving — they bypass server-side wallet simulations. Existing defenses don't reach mobile users." |
